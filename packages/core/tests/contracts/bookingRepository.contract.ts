...
import { AccommodationId, BookingId, TenantId } from "../../domain/ids.js";
import { occupancy, stay } from "../helpers.js";

const guests = occupancy(2, 0);
...
const aBooking = (
  ...
  new Booking({
    ...
    accommodationId: AccommodationId("accommodation-1"),
    guests,
    stay: stay(from, to),
    status,
  });
 ...
 */
export function bookingRepositoryContract(
  makeRepository: () => Promise<BookingRepository>
) {
