...
export { Result } from "./domain/values/Result.js";
...
export type { BookingStatus } from "./domain/entities/Booking.js";
...
// Les implémentations en mémoire : aucune dépendance, elles font tourner les
// tests et permettent une démo sans base de données.
